...
describe('remote module', () => {
  ...
  describe('remote.require', () => {
    ...
    it('should work with function properties', () => {
      ...
      expect(Object.keys(a.foo).includes('bar')).to.be.true()
      expect(Object.keys(a.foo).includes('nested')).to.be.true()
      expect(Object.keys(a.foo).includes('method1')).to.be.true()
  ...
  describe('remote object in renderer', () => {
    it('can change its properties', () => {
      ...
      expect(property.property).to.be.null()
      property.property = undefined
      expect(property.property).to.be.undefined()
  ...
  describe('remote class', () => {
    ...
    it('has unenumerable methods', () => {
      expect(base.hasOwnProperty('method')).to.be.false()
      expect(Object.getPrototypeOf(base).hasOwnProperty('method')).to.be.true()
    })

    it('keeps prototype chain in derived class', () => {
      expect(derived.method()).to.equal('method')
      expect(derived.readonly).to.equal('readonly')
      expect(derived.hasOwnProperty('method')).to.be.false()
      const proto = Object.getPrototypeOf(derived)
      expect(proto.hasOwnProperty('method')).to.be.false()
      expect(Object.getPrototypeOf(proto).hasOwnProperty('method')).to.be.true()
    })
