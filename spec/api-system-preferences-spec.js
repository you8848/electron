...
describe('systemPreferences module', () => {
  ...
  describe('systemPreferences.getAnimationSettings()', () => {
    it('returns an object with all properties', () => {
      ...
      expect(settings.shouldRenderRichAnimation).to.be.a('boolean')
      expect(settings.scrollAnimationsEnabledBySystem).to.be.a('boolean')
      expect(settings.prefersReducedMotion).to.be.a('boolean')
    })
  })
})
